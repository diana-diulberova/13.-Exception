package Homework_3.base.classes.parseData;

import Homework_3.base.abstractClasses.ADataParseProcessor;
import Homework_3.base.exceptions.FullNameReadFromDataException;
import Homework_3.base.exceptions.GetDataArrayException;
import Homework_3.base.exceptions.ParseDataException;
import Homework_3.base.exceptions.ParseDataToIntegerException;
...
public class CDataParseProcessor extends ADataParseProcessor {
    ...
    /**
     * Геттер для массива с элементами распарсеной строки.
